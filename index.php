        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="usuario_create.php" class="btn btn-primary float-end">Adicionar usuário</a> <!-- Botão para adicionar um novo usuário -->
              </h4>
            </div>
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                  $sql='SELECT * FROM usuarios'; // Consulta para recuperar todos os usuários do banco de dados
                  ...
                  <tr>
                    ...
                    <td><?=$usuario['nome']?></td>
                    <td><?=$usuario['email']?></td>
                    <td><?=date("d/m/Y", strtotime($usuario['data_nascimento']))?></td> <!-- Formatação da data de nascimento -->
                    <td>
                      <a href="usuario-view.php?id=<?=$usuario['id']?>" class="btn btn-secondary btn-sn">
                        <span class="bi-eye-fill"></span>&nbspVisualizar <!-- Botão para visualizar o usuário -->
                      </a>
                      <a href="usuario-edit.php?id=<?=$usuario['id']?>" class="btn btn-success btn-sn">
                        <span class="bi-pencil-fill"></span>&nbspEditar <!-- Botão para editar informações do usuário -->
                      </a>
                  ...
                  <?php 
                    ...
                    echo "<h5> Nenhum usuário encontrado</h5>"; // Exibe mensagem caso não haja usuários no banco
                  }
                  ?>
                </tbody>
              </table>
